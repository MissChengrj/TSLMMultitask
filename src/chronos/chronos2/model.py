...
class Chronos2Model(PreTrainedModel):
    ...
    def forward(
        ...
        # Forecasting mode uses the future-token hidden states. Context reconstruction is
        # implemented by task-specific wrappers instead of changing the base model contract.
