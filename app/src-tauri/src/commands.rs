...
pub async fn run_prediction(
    ...
    crate::data::DataProcessor::new()
        .run_prediction(
            ...
            &python_path,
            &model_dir,
            enable_cpu_quantization
        )
        .map_err(|e| e.to_string())
}

#[command]
pub async fn get_models(model_dir: String) -> Result<Vec<ModelInfo>, String> {
    Ok(crate::data::DataProcessor::new().get_models(&model_dir))
}
